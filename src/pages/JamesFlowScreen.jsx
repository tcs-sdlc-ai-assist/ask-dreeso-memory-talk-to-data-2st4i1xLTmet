    ...
    >
      <div className="flex items-start justify-between gap-2 mb-2">
        ...
        <div
          ...
          style={{ backgroundColor: stat.color ? `${stat.color}20` : 'rgba(245,158,11,0.12)' }}
        >
          <StatIcon
            icon={stat.icon}
            className="w-4 h-4"
...
function LoadingSpinner() {
  return (
    <svg
      className="w-8 h-8 animate-spin text-accent-orange"
      viewBox="0 0 24 24"
      fill="none"
      aria-hidden="true"
    >
  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 px-4 animate-fade-in">
      ...
      <p className="text-xs text-slate-500">
        Analyzing sales and pipeline data across enterprise systems
      </p>
...
/**
 * Screen 15: Sales & BD pipeline overview with query input and quick stats
 * @param {Object} props
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <GlassCard variant="elevated" className="!p-5 sm:!p-6">
        <h2 className="text-base sm:text-lg font-semibold text-slate-100 mb-4">
          Ask anything about sales & business development
        </h2>
        <QueryInput
          onSubmit={onQuerySubmit}
          isLoading={isLoading}
          persona={persona}
          placeholder="e.g., Show me the sales pipeline, What is our win rate this quarter?"
        />
      </GlassCard>
      ...
      {!activeCluster && defaultResult && (
        <div className="animate-fade-in" style={{ animationDelay: '200ms', animationFillMode: 'both' }}>
          <ForecastChart
            ...
            subtitle="Key sales and pipeline metrics across your active opportunities"
          />
        </div>
      )}
    </div>
...
/**
 * Screen 16-17: Result display screen with structured output
 * @param {Object} props
...
/**
 * Screen 18: Action execution and confirmation screen
 * @param {Object} props
...
/**
 * James persona flow screen component (Screens 15-18).
 * Screen 15: Sales & BD pipeline overview with query input.
 * Screen 16: Revenue forecast and deal analytics results.
 * Screen 17: Client relationship and win/loss analysis.
 * Screen 18: Sales action execution (Salesforce).
 * Each screen supports all view states (query, loading, result, CTA, action, confirmation).
 *
 * @param {Object} props
 * @param {string} [props.className] - Additional class names for the wrapper
 * @returns {React.ReactElement} The James flow screen component
 */
export function JamesFlowScreen({ className }) {
  ...
  const currentPersona = persona || PERSONAS.JAMES.id;
  const currentRole = role || PERSONAS.JAMES.role;
  const currentCluster = cluster || PERSONAS.JAMES.cluster;
  ...
  const renderCurrentView = () => {
    switch (viewState) {
      ...
      case VIEW_STATES.LOADING:
        return <QueryLoadingState message="Analyzing sales and pipeline data..." />;
            ...
            <GlassCard variant="elevated" className="!p-6 sm:!p-8">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-sm text-slate-300 leading-relaxed mb-6 max-w-md">
                  Your sales action has been executed and logged. You can continue querying or return to the dashboard.
                </p>
          ...
          <div className="px-1 py-3 animate-fade-in">
            <button
              ...
              className={classNames(
                ...
                'focus:outline-none focus:text-accent-orange'
              )}
              aria-label="Back to dashboard"
            >
              <svg
...
JamesFlowScreen.propTypes = {
  className: PropTypes.string,
};

export default JamesFlowScreen;