    ...
    >
      <div className="flex items-start justify-between gap-2 mb-2">
        ...
        <div
          ...
          style={{ backgroundColor: stat.color ? `${stat.color}20` : 'rgba(139,92,246,0.12)' }}
        >
          <StatIcon
            icon={stat.icon}
            className="w-4 h-4"
...
function LoadingSpinner() {
  return (
    <svg
      className="w-8 h-8 animate-spin text-accent-purple"
      viewBox="0 0 24 24"
      fill="none"
      aria-hidden="true"
    >
  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 px-4 animate-fade-in">
      ...
      <p className="text-xs text-slate-500">
        Analyzing engineering and quality data across enterprise systems
      </p>
...
/**
 * Screen 11: Workforce Planning overview with query input and quick stats
 * @param {Object} props
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <GlassCard variant="elevated" className="!p-5 sm:!p-6">
        <h2 className="text-base sm:text-lg font-semibold text-slate-100 mb-4">
          Ask anything about engineering & quality
        </h2>
        <QueryInput
          onSubmit={onQuerySubmit}
          isLoading={isLoading}
          persona={persona}
          placeholder="e.g., Show me open RFIs, Show me quality metrics, Safety compliance report"
        />
      </GlassCard>
      ...
      {!activeCluster && defaultResult && (
        <div className="animate-fade-in" style={{ animationDelay: '200ms', animationFillMode: 'both' }}>
          <ForecastChart
            ...
            subtitle="Key engineering and quality metrics across your active projects"
          />
        </div>
      )}
    </div>
...
/**
 * Screen 12-13: Result display screen with structured output
 * @param {Object} props
...
/**
 * Screen 14: Action execution and confirmation screen
 * @param {Object} props
...
/**
 * Sophie persona flow screen component (Screens 11-14).
 * Screen 11: Workforce Planning overview with query input.
 * Screen 12: Schedule and milestone analytics results.
 * Screen 13: Resource allocation and risk signals.
 * Screen 14: PM action execution (Primavera + Procore).
 * Each screen supports all view states (query, loading, result, CTA, action, confirmation).
 *
 * @param {Object} props
 * @param {string} [props.className] - Additional class names for the wrapper
 * @returns {React.ReactElement} The Sophie flow screen component
 */
export function SophieFlowScreen({ className }) {
  ...
  const currentPersona = persona || PERSONAS.SOPHIE.id;
  const currentRole = role || PERSONAS.SOPHIE.role;
  const currentCluster = cluster || PERSONAS.SOPHIE.cluster;
  ...
  const renderCurrentView = () => {
    switch (viewState) {
      ...
      case VIEW_STATES.LOADING:
        return <QueryLoadingState message="Analyzing engineering and quality data..." />;
            ...
            <GlassCard variant="elevated" className="!p-6 sm:!p-8">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-sm text-slate-300 leading-relaxed mb-6 max-w-md">
                  Your engineering action has been executed and logged. You can continue querying or return to the dashboard.
                </p>
          ...
          <div className="px-1 py-3 animate-fade-in">
            <button
              ...
              className={classNames(
                ...
                'focus:outline-none focus:text-accent-purple'
              )}
              aria-label="Back to dashboard"
            >
              <svg
...
SophieFlowScreen.propTypes = {
  className: PropTypes.string,
};

export default SophieFlowScreen;